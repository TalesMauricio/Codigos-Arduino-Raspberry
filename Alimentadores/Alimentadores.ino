 ...
 *  
 *   Este não é o código principal. Os blocos main e loop estão no arquivo (aba) main. Isto foi feito para possibilitar a
 *   declaração de todas as funções de modo simples no arduino.
*/
